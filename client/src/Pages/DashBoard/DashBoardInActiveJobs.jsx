...
import { getAdminInActiveJob } from "../../Services/api/AdminEndpoints";

const DashBoardInActiveJobs = () => {
  ...
  const fetchData = async () => {
    showLoader();
    const res = await getAdminInActiveJob(search);
    if ((res.status = 200)) {
...
export default DashBoardInActiveJobs;
