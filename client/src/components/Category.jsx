      ...
      <div className="grid md:grid-cols-4 sm:grid-cols-1 gap-6 ">
        {jobCategory.map((data) => (
          <div className="flex justify-center ">
            <div className="block min-w-[18rem] rounded-lg bg-secondary text-primary shadow-secondary-1 border hover:bg-blue hover:cursor-pointer transition-colors duration-300 ease-in-out">
